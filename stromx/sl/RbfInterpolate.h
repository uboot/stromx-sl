...
#ifndef STROMX_SL_RBFINTERPOLATE_H
#define STROMX_SL_RBFINTERPOLATE_H
...
class STROMX_SL_API RbfInterpolate : public runtime::OperatorKernel
{   
public:      
    enum DataId
    {
    ...
    virtual OperatorKernel* clone() const { return new RbfInterpolate; }
...
#endif // STROMX_SL_RBFINTERPOLATE_H
